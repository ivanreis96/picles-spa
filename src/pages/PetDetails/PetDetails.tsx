...
import { ImageBase64 } from "../../components/common/ImgBase64";
import { Skeleton } from "../../components/common/skeleton";
import { Button, ButtonVariant } from "../../components/common/Button";
import imgWhatsaap from '../../assets/whatsapp.svg'
                        ...
                        <>
                            ...
                            {!petIsError && (
                                <>
                                    ...
                                    {!shelterIsError && (
                                        <a 
                                            href={`https://wa.me/${shelterData?.shelterWhatsApp}?text=Olá, gostaria de falar sobre o ${petData?.name} `} target="_blank">
                                            
                                            <Button variant={ButtonVariant.Text}>
                                                <span className={styles.buttonWhatsapp}>
                                                    <img src={imgWhatsaap} alt="" />
                                                    <span>Entre em contato com o abrigo</span>
                                                </span>
                                            </Button>
                                        </a>
                                    )}
